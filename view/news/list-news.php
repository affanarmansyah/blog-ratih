...
$listNews = $news->pageListNews($_GET);
            ...
            <div class="content-wrapper">
                <section class="content-header">
                    <div class="container-fluid">
                        ...
                        <div class="mt-3"><a href="<?= $baseUrl ?>/view/news/create-news.php" style="background-color: #007bff; padding: 5px;  border: none; color: #fff; border-radius: 5px;">+ &nbsp; Create News</a></div>
                    </div><!-- /.container-fluid -->
                </section>
                        ...
                        <div class="card-body">
                            <table class="table table-bordered">
                                ...
                                <tbody>
                                    ...
                                    foreach ($listNews['newsRows'] as $row) {
                                    ?>
                                        <tr>
                                            <td><?php echo $no; ?></td>
